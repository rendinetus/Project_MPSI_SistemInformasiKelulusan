<div class="well">
    <div class=" alert alert-dismissable alert-success">
        <h4 align="center"><b>JADWAL PENGUMUMAN</br>HASIL KELULUSAN SEKOLAH</b></h4>
    </div>
    <form class="form-horizontal" method="post">
        ...
        if (isset($_REQUEST['submit'])) {
            ...
            $qCfg = "UPDATE tbl_profil SET tahun='$cfgTahun',tgl_pengumuman='$cfgTgl' WHERE id_profil='1'";
        ...
        -->
            ...
            <div class="form-group">
                <p align="left">
                    <button type="button" id="btEnable" class="btn btn-warning"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span>&nbsp; <b>EDIT DATA</b></button>
